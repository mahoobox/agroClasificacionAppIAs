  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        //backgroundColor: Color.fromARGB(185, 0, 0, 0)GB(255, 0, 0, 0).withOpacity(0.5),
        title: Text('Analizador de Apetencia de Ganado'),
        backgroundColor: Color.fromARGB(255, 127, 0, 71),
      ),
      body: Center(
